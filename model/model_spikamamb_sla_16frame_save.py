...
if __name__ == '__main__':
    ...
    # data = np.load("/home/dsz/Documents/eventcamera/ExACT/event_npz_16/001/01-m-b-1/01-m-b-1.npz",allow_pickle=True)
    # events = data['images']
    # if events.ndim < 4:
    ...
    # pretrained_dict = torch.load('/home/dsz/Documents/eventcamera/spikformer/cifar10dvs/complete_model_efaction5.434782608695652.pth')
    # torch.save(pretrained_dict.state_dict(), 'tttttttttt1.pth')
    # pretrained_dict = torch.load('tttttttttt1.pth')
    # # 获取新模型的参数字典
