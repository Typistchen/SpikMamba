...
from seact_sampled_dataset import seact_sampled,event_sampled_frames_collate_func
...
cfg = read_yaml('/home/dsz/Documents/eventcamera/ExACT/Configs/seact.yaml')
...
def main(args):
    ...
    #     drop_last=True,
    #     pin_memory=True)
    val_dataset = seact_sampled(cfg['Dataset']['Val']['Path'], cfg['Dataset']['Classnames'])
    ...
    train_dataset = seact_sampled(cfg['Dataset']['Train']['Path'], cfg['Dataset']['Classnames'])
    ...
    for epoch in range(args.start_epoch, num_epochs):
        ...
        if max_test_acc1 < test_acc1:
            ...
            save_max = True
            name = str(test_acc1) 
            model_name = "complete_model" + name + ".h5"
