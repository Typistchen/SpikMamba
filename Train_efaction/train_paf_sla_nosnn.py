...
import   model_spikamamb_sla_16frame_nosnn,utils
...
from efaction_sampled_dataset import efaction_sampled,event_sampled_frames_collate_func
...
cfg = read_yaml('/home/dsz/Documents/eventcamera/ExACT/Configs/efaction_npz.yaml')
...
def parse_args():
    ...
    parser.add_argument('--num-classes', type=int, default=32, metavar='N',
    ...
    parser.add_argument('--decay-epochs', type=float, default=400, metavar='N',
                        help='epoch interval to decay LR')
    parser.add_argument('--warmup-epochs', type=int, default=200, metavar='N',
                        help='epochs to warmup LR, if scheduler supports')
    parser.add_argument('--cooldown-epochs', type=int, default=200, metavar='N',
                        help='epochs to cooldown LR at min_lr, after cyclic schedule ends')
    parser.add_argument('--patience-epochs', type=int, default=200, metavar='N',
...
def main(args):
    ...
    #     drop_last=True,
    #     pin_memory=True)
    val_dataset = efaction_sampled(cfg['Dataset']['Val']['Path'], cfg['Dataset']['Classnames'])
    ...
    train_dataset = efaction_sampled(cfg['Dataset']['Train']['Path'], cfg['Dataset']['Classnames'])
    ...
    for epoch in range(args.start_epoch, num_epochs):
        ...
        if max_test_acc1 < test_acc1:
            ...
            save_max = True
            name = str(test_acc1) 
            model_name = "complete_model_efaction" + name + ".pth"
