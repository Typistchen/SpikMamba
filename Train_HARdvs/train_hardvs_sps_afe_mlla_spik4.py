...
import model, utils, model_afe, model_spikamamb_sla_8frame, model_afe_spik2,model_spikmamba_bisla_8frame,model_spikmamba_bissm_bisla_8frame
...
def parse_args():
    ...
    parser.add_argument('--epochs', type=int, default=196, metavar='N',
